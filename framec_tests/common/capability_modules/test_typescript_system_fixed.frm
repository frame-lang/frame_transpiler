# TypeScript Frame system test without module imports
# This tests if we can manually include capability module functionality
    ...
    machine:
        $Start {
            demonstrateCapabilities() {
                ...
                print("This demonstrates that Frame systems can work with capability-style patterns in TypeScript")
            }
        }
