...
#Naming
    ...
    var snake_log:`ArrayList<Integer>` = `new ArrayList<Integer>()`
    var CamelLog:`ArrayList<Integer>` = `new ArrayList<Integer>()`
    var log123:`ArrayList<Integer>` = `new ArrayList<Integer>()`
    var finalLog:`ArrayList<Integer>` = `new ArrayList<Integer>()`
##
