...
#Naming
    ...
    call [eventStr:string param:int]
    ...
    -actions-
    snake_action [snake_param:int] {`this.snake_log.Add(snake_param);`}
    CamelAction [CamelParam:int] {`this.CamelLog.Add(CamelParam);`}
    action123 [param123:int] {`this.log123.Add(param123);`}
    logFinal [r:int] {`this.finalLog.Add(r);`}

    -domain-
    var snake_domain_var:int = 300 
    var CamelDomainVar:int = 550 
    var domainVar123:int = 150
    var snake_log:`List<int>` = `new List<int>()`
    var CamelLog:`List<int>` = `new List<int>()`
    var log123:`List<int>` = `new List<int>()`
    var finalLog:`List<int>` = `new List<int>()`
##
