...
# Port of legacy test_v056_walrus_and_literals.frm to V3 syntax.
...
fn main() {
    print("=== Testing Walrus Operator (V3) ===")
    test_walrus_operator()

    print("\n=== Testing Numeric Underscores (V3) ===")
    test_numeric_underscores()

    print("\n=== Testing Complex Numbers (V3) ===")
    test_complex_numbers()

    print("\n=== Testing Combined Features (V3) ===")
    test_combined_features()

    print("\n=== All v0.56 features test complete (V3) ===")
}
