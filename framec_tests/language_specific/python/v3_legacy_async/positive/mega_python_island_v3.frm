...
# Port of legacy test_python_island_mega_syntax.frm to V3 syntax.
# Purpose: exercise a very large slice of Python 3 syntax inside native code, via fn main().

fn main() {
            # Begin native Python mega-syntax demo inside a Frame function
