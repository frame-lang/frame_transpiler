...
class FirstSystem:
    def __init__(self):
        ...
        self.__compartment = FrameCompartment('__firstsystem_state_Begin', None, None, None, None)
    ...
    def __firstsystem_state_Begin(self, __e, compartment):
    ...
    def _sBegin(self, __e):
        return self.__firstsystem_state_Begin(__e, None)
    ...
    def __router(self, __e, compartment=None):
        ...
        if target_compartment.state == '__firstsystem_state_Begin':
            self.__firstsystem_state_Begin(__e, target_compartment)
...
class SecondSystem:
    def __init__(self):
        # Create and initialize start state compartment
        self.__compartment = FrameCompartment('__secondsystem_state_Idle', None, None, None, None)
        self.__next_compartment = None
        self.return_stack = [None]
    ...
    def __secondsystem_state_Idle(self, __e, compartment):
    ...
    def _sIdle(self, __e):
        return self.__secondsystem_state_Idle(__e, None)
    ...
    def __router(self, __e, compartment=None):
        target_compartment = compartment or self.__compartment
        if target_compartment.state == '__secondsystem_state_Idle':
            self.__secondsystem_state_Idle(__e, target_compartment)
