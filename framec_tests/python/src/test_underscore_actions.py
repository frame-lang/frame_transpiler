...
class Worker:
    def __init__(self):
        ...
        self.__compartment = FrameCompartment('__worker_state_Ready', None, None, None, None, {}, {})
    ...
    def __worker_state_Ready(self, __e, compartment):
    ...
    def _sReady(self, __e):
        return self.__worker_state_Ready(__e, None)
    # ===================== Actions Block =================== #
    ...
    def __router(self, __e, compartment=None):
        ...
        if target_compartment.state == '__worker_state_Ready':
            self.__worker_state_Ready(__e, target_compartment)
