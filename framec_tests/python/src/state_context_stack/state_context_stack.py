...
class StateContextStack:
    ...
    def __mux(self, e):
        if self.__compartment.state == self.__statecontextstack_state_A:
            self.__statecontextstack_state_A(e)
        elif self.__compartment.state == self.__statecontextstack_state_B:
            self.__statecontextstack_state_B(e)
        elif self.__compartment.state == self.__statecontextstack_state_C:
