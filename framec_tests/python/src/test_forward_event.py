...
class TestForwardEvent:
    def __init__(self):
        ...
        self.__compartment = FrameCompartment('__testforwardevent_state_Child', None, None, None, FrameCompartment('__testforwardevent_state_Parent', None, None, None, None))
    ...
    def _sChild(self, __e):
        return self.__testforwardevent_state_Child(__e, None)
    def _sParent(self, __e):
        return self.__testforwardevent_state_Parent(__e, None)
