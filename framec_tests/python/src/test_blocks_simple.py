...
class BlocksTest:
    ...
    def work(self):# DEBUG_EXPR_TYPE: Discriminant(4)
    ...
    def __blockstest_state_Start(self, __e, compartment):
        if __e._message == "$>":# DEBUG_EXPR_TYPE: Discriminant(4)
            ...
            print("machine: start entered")# DEBUG_EXPR_TYPE: Discriminant(4)
            
            self.work()# DEBUG_EXPR_TYPE: Discriminant(4)
            
            finish()
            return
        elif __e._message == "go":# DEBUG_EXPR_TYPE: Discriminant(4)
    ...
    def finish_do(self):
        ...
        print("actions: finish called")# DEBUG_EXPR_TYPE: Discriminant(4)
        
        print("domain: value=" + str(value))
        return
