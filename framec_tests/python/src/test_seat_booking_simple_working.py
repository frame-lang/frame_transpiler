...
class SeatManager:
    ...
    def test_operations(self):# DEBUG_EXPR_TYPE: Discriminant(4)
        ...
        print("Testing operations...")# DEBUG_EXPR_TYPE: Discriminant(4)
        
        create_seat("A1")# DEBUG_EXPR_TYPE: Discriminant(4)
        
        process_booking("A1","user123")
    
    def create_seat(self,seat_id):# DEBUG_EXPR_TYPE: Discriminant(4)
        
        print("Creating seat: " + seat_id)
    
    def process_booking(self,seat_id,user_id):# DEBUG_EXPR_TYPE: Discriminant(4)
    ...
    def __seatmanager_state_Start(self, __e, compartment):
    ...
    def _sStart(self, __e):
        return self.__seatmanager_state_Start(__e, None)
    ...
    def __router(self, __e, compartment=None):
        ...
        if target_compartment.state == '__seatmanager_state_Start':
            self.__seatmanager_state_Start(__e, target_compartment)
