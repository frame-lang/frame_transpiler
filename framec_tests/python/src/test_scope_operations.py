...
def main():# DEBUG_EXPR_TYPE: Discriminant(4)
    ...
    sys.run_operation()# DEBUG_EXPR_TYPE: Discriminant(4)
    
    print("=== Testing Function Scope ===")# DEBUG_EXPR_TYPE: Discriminant(4)
    
    test_function_variables()
    return

def test_function_variables():# DEBUG_EXPR_TYPE: Discriminant(4)
    
    print("In function scope")
    func_var = "function_variable"
    system_instance = TestSystem()# DEBUG_EXPR_TYPE: Discriminant(4)
    
    print(func_var)# DEBUG_EXPR_TYPE: Discriminant(4)
    
    system_instance.run_operation()
    return
class TestSystem:
    def __init__(self):
