...
class StartStateParameters:
    ...
    def __init__(self,start_state_state_param_p1):
        
         # Create and initialize start state compartment.
        
        next_compartment = None
        next_compartment = StartStateParametersCompartment('__startstateparameters_state_S1', next_compartment)
        self.__compartment = next_compartment
        self.__next_compartment = None
        self.return_stack = [None]
        self.__compartment.state_args["p1"] = start_state_state_param_p1
...
class StartStateParametersCompartment:
