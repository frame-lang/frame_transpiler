...
class TestSystem:
    ...
    def __init__(self,start_state_state_param_A):
        
         # Create and initialize start state compartment.
        
        next_compartment = None
        next_compartment = TestSystemCompartment('__testsystem_state_Start', next_compartment)
    ...
    def __testsystem_state_Start(self, __e, compartment):
        if __e._message == "$>":
            print((compartment.state_args["A"]))
            return
