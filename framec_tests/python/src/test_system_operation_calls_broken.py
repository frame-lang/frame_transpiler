#Emitted from framec_v0.30.0 - BROKEN VERSION (shows the bug)
...
class TestOperationCalls:
    ...
    def main_operation(self):# DEBUG_EXPR_TYPE: Discriminant(4)
        ...
        helper_operation()  # BUG: Missing self. prefix - this will cause NameError
...
if __name__ == '__main__':
    print("=== Testing Operations Call Bug (Broken Version - Shows the Bug) ===")
    test = TestOperationCalls()
    test.test()  # This will trigger the operations call and show the NameError
