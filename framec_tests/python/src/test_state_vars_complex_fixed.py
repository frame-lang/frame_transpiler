...
class StateManager:
    ...
    def __statemanager_state_Init(self, __e, compartment):
        if __e._message == "start":
            ...
            next_compartment = FrameCompartment('__statemanager_state_Working', None, None, None, None, {})
    ...
    def __statemanager_state_Working(self, __e, compartment):
        if __e._message == "process":
            ...
            next_compartment = FrameCompartment('__statemanager_state_Done', None, None, None, None, {})
            self.__transition(next_compartment)
            return
        elif __e._message == "reset":
            print("Resetting from working state")
            next_compartment = FrameCompartment('__statemanager_state_Init', None, None, None, None, {})
            self.__transition(next_compartment)
            return
