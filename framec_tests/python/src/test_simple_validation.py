...
class ValidationTest:
    ...
    def do_work(self):# DEBUG_EXPR_TYPE: Discriminant(4)
    ...
    def __validationtest_state_Start(self, __e, compartment):
        if __e._message == "$>":# DEBUG_EXPR_TYPE: Discriminant(4)
            ...
            self.do_work()# DEBUG_EXPR_TYPE: Discriminant(4)
            
            print("Actions: calling finish_work")# DEBUG_EXPR_TYPE: Discriminant(4)
            
            finish_work()
            return
        elif __e._message == "test_interface":# DEBUG_EXPR_TYPE: Discriminant(4)
    ...
    def finish_work_do(self):
        ...
        print("Actions: finish_work called")# DEBUG_EXPR_TYPE: Discriminant(4)
        
        print("Domain: counter = " + str(counter))
        return
