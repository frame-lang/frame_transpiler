...
class TestOperationCalls:
    ...
    def main_operation(self):# DEBUG_EXPR_TYPE: Discriminant(4)
        ...
        helper_operation()# DEBUG_EXPR_TYPE: Discriminant(4) ← BUG: Missing self.
...
# Test the ACTUAL transpiler output with the bug
if __name__ == '__main__':
    print("=== Testing ACTUAL Transpiler Output (Should Show Bug) ===")
    test = TestOperationCalls()
    test.test()  # This should demonstrate the NameError bug
    print("=== This won't print if bug exists ===")