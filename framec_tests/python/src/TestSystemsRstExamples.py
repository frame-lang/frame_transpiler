...
class NoParameters:
    ...
    def __init__(self):
        ...
        next_compartment = NoParametersCompartment('__noparameters_state_Start', next_compartment)
    ...
    def __router(self, __e, compartment=None):
        ...
        if target_compartment.state == '__noparameters_state_Start':
            self.__noparameters_state_Start(__e, target_compartment)
