...
class AllBlocksTest:
    ...
    def __allblockstest_state_Processing(self, __e, compartment):
        if __e._message == "$>":# DEBUG_EXPR_TYPE: Discriminant(4)
            ...
            test_result = result# DEBUG_EXPR_TYPE: Discriminant(4)
            
            print("Machine: result stored as " + test_result)# DEBUG: TransitionStmt
    ...
    def __allblockstest_state_Complete(self, __e, compartment):
        if __e._message == "$>":# DEBUG_EXPR_TYPE: Discriminant(4)
            ...
            self.return_stack[-1] = test_result
            return
    ...
    def complete_process_do(self):
        ...
        print("Actions: stored result is " + test_result)
        return
