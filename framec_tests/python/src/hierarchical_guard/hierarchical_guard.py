...
class HierarchicalGuard:
    ...
    def __mux(self, e):
        if self.__compartment.state == self.__hierarchicalguard_state_I:
            self.__hierarchicalguard_state_I(e)
        elif self.__compartment.state == self.__hierarchicalguard_state_S:
            self.__hierarchicalguard_state_S(e)
        elif self.__compartment.state == self.__hierarchicalguard_state_S0:
            self.__hierarchicalguard_state_S0(e)
        elif self.__compartment.state == self.__hierarchicalguard_state_S1:
            self.__hierarchicalguard_state_S1(e)
        elif self.__compartment.state == self.__hierarchicalguard_state_S2:
            self.__hierarchicalguard_state_S2(e)
        elif self.__compartment.state == self.__hierarchicalguard_state_S3:
            self.__hierarchicalguard_state_S3(e)
        elif self.__compartment.state == self.__hierarchicalguard_state_S4:
