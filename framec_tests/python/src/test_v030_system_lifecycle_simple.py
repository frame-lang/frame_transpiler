...
class SimpleSystem:
    def __init__(self):
        ...
        self.__compartment = FrameCompartment('__simplesystem_state_Start', None, None, None, None)
    ...
    def _sStart(self, __e):
        return self.__simplesystem_state_Start(__e, None)
    def _sEnd(self, __e):
        return self.__simplesystem_state_End(__e, None)
    ...
    def __router(self, __e, compartment=None):
        ...
        if target_compartment.state == '__simplesystem_state_Start':
            self.__simplesystem_state_Start(__e, target_compartment)
        elif target_compartment.state == '__simplesystem_state_End':
            self.__simplesystem_state_End(__e, target_compartment)
