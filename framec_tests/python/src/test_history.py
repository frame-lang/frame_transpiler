...
class History103:
    ...
    def __init__(self):
        ...
        next_compartment = History103Compartment('__history103_state_A', next_compartment)
    ...
    def __history103_state_A(self, __e, compartment):
        if __e._message == "$>":
            ...
            # $$[+]
            next_compartment = None
            next_compartment = History103Compartment('__history103_state_C', next_compartment)
