...
class Test:
    def __init__(self):
        ...
        self.__compartment = FrameCompartment('__test_state_Start', None, None, None, None, {}, {})
    ...
    def __test_state_Start(self, __e, compartment):
        if __e._message == "test":
            if True:
                self.return_stack[-1] = "if"
                return
            elif False:
                self.return_stack[-1] = "elif"
                return
    ...
    def _sStart(self, __e):
        return self.__test_state_Start(__e, None)
