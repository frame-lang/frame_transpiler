...
def main():
    hws = HelloWorldWithDomainSystem()# DEBUG_EXPR_TYPE: Discriminant(4)
...
class HelloWorldWithDomainSystem:
    ...
    def __helloworldwithdomainsystem_state_Hello(self, __e, compartment):
        if __e._message == "sayHello":# DEBUG_EXPR_TYPE: Discriminant(4)
            ...
            self.actionWriteHello_do()# DEBUG: TransitionStmt
    ...
    def __helloworldwithdomainsystem_state_World(self, __e, compartment):
        if __e._message == "sayWorld":# DEBUG_EXPR_TYPE: Discriminant(4)
            ...
            self.actionWriteWorld_do()# DEBUG: TransitionStmt
    ...
    def _sHello(self, __e):
        return self.__helloworldwithdomainsystem_state_Hello(__e, None)
    def _sWorld(self, __e):
        return self.__helloworldwithdomainsystem_state_World(__e, None)
    def _sDone(self, __e):
        return self.__helloworldwithdomainsystem_state_Done(__e, None)
    # ===================== Actions Block =================== #
