...
- Frame statements are strictly SOL‑anchored (start of line), ignored in strings/comments/templates.
...
- Add negative fixtures alongside positive ones for policy changes (e.g., inline target annotations).
