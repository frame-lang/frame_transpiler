...
impl AstVisitor for GolangVisitor {
    ...
    fn visit_system_node(&mut self, system_node: &SystemNode) {
        ...
        self.newline();
        self.newline();
        self.add_code(&format!("type State uint64"));
        self.newline();
        self.newline();
        ...
        self.newline();
        self.newline();
        self.add_code(&format!("type {} struct {{", system_node.name));
        self.indent();
        self.newline();
        ...
        self.newline();
        self.add_code(&format!("func New{} *{} {{", system_node.name, system_node.name));
        self.indent();
        self.newline();
 ...
 //           "e := FrameEvent{\"{}\", {}, nil}})",
    ...
    fn visit_state_node(&mut self, state_node: &StateNode) {
        ...
        self.newline();
        self.add_code(&format!(
            "func (m *machine) _{}_(e *FrameEvent) {{",
