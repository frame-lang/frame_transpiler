...
impl CsVisitorForBob {
    ...
    fn format_parameter_list_to_string(
        &mut self,
    ...
    fn generate_default_actions(&mut self) {
        ...
        self.newline();
        self.add_code(
            "protected virtual void Print_do(object o1, object o2) { FrameConsolePrint(o1, o2); }",
        );
        self.newline();
...
impl AstVisitor for CsVisitorForBob {
    ...
    fn visit_system_node(&mut self, system_node: &SystemNode) {
        ...
        self.newline();
        self.add_code(&format!(
            "public partial class {}Base : FrameController {{",
            system_node.name
        ));
        self.indent();
        self.newline();
        self.add_code("public FrameController self;");
        self.newline();
        self.newline();
    ...
    fn visit_state_stack_operation_statement_node(
            ...
            .operation_t
        {
            ...
            StateStackOperationType::Pop => {
                if self.generate_state_context {
                    self.add_code("let stateContext = _stateStack_pop_()");
                } else {
    ...
    fn visit_action_node(&mut self, action_decl_node: &ActionNode) {
        ...
        action_code.push_str(") { throw new NotImplementedException(); }");
