...
impl ModuleCache {
    ...
    pub fn get(
        ...
        _file_path: &Path,
        _content_hash: &str,
    ) -> ModuleResult<Option<super::compiler::CompiledModule>> {
    ...
    pub fn put(
        &mut self,
        _file_path: &Path,
        _module: &super::compiler::CompiledModule,
    ) -> ModuleResult<()> {
    ...
    pub fn load(&mut self, module_path: &str) -> ModuleResult<Option<CachedModule>> {
        ...
        self.memory_cache
            .insert(module_path.to_string(), cached.clone());
    ...
    pub fn save(&mut self, module_path: &str, cached_module: &CachedModule) -> ModuleResult<()> {
        ...
        // Store in memory cache
        self.memory_cache
            .insert(module_path.to_string(), cached_module.clone());
