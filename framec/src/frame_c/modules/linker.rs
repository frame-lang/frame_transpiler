    ...
    fn filter_module_code(&self, code: &str) -> String {
        ...
        for line in code.lines() {
            ...
            let should_skip_version = match self.target_language {
                ...
                _ => trimmed.starts_with("// Emitted from framec") || trimmed.starts_with("#Emitted from framec"),
            };
            ...
            let should_skip_import = match self.target_language {
                ...
                _ => {
                    trimmed.starts_with("import ") || trimmed.starts_with("export ") || trimmed.starts_with("from ")
                }
            };
            ...
            if self.target_language == TargetLanguage::Python3 && line.starts_with("class FrameEvent:") {
                in_frame_event = true;
                skip_next_blank = true;
                continue;
            }
            ...
            if self.target_language == TargetLanguage::Python3 && line.starts_with("class FrameCompartment:") {
