...
mod tests {
    ...
    fn remove_event_sent_callbacks() {
        ...
        let mut sm = Demo::new();
        sm.event_monitor_mut()
            .add_event_sent_callback(Callback::new("zero", |_e: &EventPtr| {
                tape_mutex.lock().unwrap().push("0".to_string());
            }));
        sm.event_monitor_mut()
            .add_event_sent_callback(Callback::new("one", |_e: &EventPtr| {
                tape_mutex.lock().unwrap().push("1".to_string());
            }));
        sm.event_monitor_mut()
            .add_event_sent_callback(Callback::new("event", |e: &EventPtr| {
                tape_mutex.lock().unwrap().push(e.info().name.to_string());
            }));
        sm.event_monitor_mut()
            .add_event_sent_callback(Callback::new("one", |_e: &EventPtr| {
    ...
    fn remove_event_handled_callbacks() {
        ...
        let mut sm = Demo::new();
        sm.event_monitor_mut()
            .add_event_handled_callback(Callback::new("zero", |_e: &EventPtr| {
                tape_mutex.lock().unwrap().push("0".to_string());
            }));
        sm.event_monitor_mut()
            .add_event_handled_callback(Callback::new("one", |_e: &EventPtr| {
                tape_mutex.lock().unwrap().push("1".to_string());
            }));
        sm.event_monitor_mut()
            .add_event_handled_callback(Callback::new("event", |e: &EventPtr| {
                tape_mutex.lock().unwrap().push(e.info().name.to_string());
            }));
        sm.event_monitor_mut()
            .add_event_handled_callback(Callback::new("one", |_e: &EventPtr| {
    ...
    fn machines_in_separate_threads() {
        ...
        let thread1 = thread::spawn(move || {
            ...
            sm1.event_monitor_mut()
                .add_event_sent_callback(Callback::new("test1", |e: &EventPtr| {
        ...
        let thread2 = thread::spawn(move || {
            ...
            sm2.event_monitor_mut()
                .add_event_sent_callback(Callback::new("test2", |e: &EventPtr| {
