...
Purpose
- Represent native body content and embedded Frame statements in a single, ordered structure for stable codegen and mapping.
...
- Print via native code generators to ensure formatting determinism; attach synthesized spans mapped to Frame statement lines.
...
Validation
- Golden tests for Frame‑statement expansions; AST dump includes MixedBody with spans.
