...
### 1b. Grammar and Architecture Compliance (V4)
- All new bugs and proposed fixes MUST respect the V4 architecture and grammar specs:
  - Language Reference: `docs/framelang/v4/frame_v4_lang_reference.md`
  - Architecture: `docs/framelang/v4/frame_v4_architecture.md`
  - Codegen: `docs/framelang/v4/frame_v4_codegen_spec.md`
- If a bug report or "fix" relies on syntax or semantics that contradict these docs (for example, using non‑Python constructs inside `@@target python_3` bodies), maintainers should:
