...
- #077: Python event branch with comment-only body misses pass — `fixed_version: v0.86.47`
- #074: TypeScript generator omits actions/domain declarations and drops interface params — `fixed_version: v0.86.43`
- #073: TypeScript generator emits duplicate class methods per state — `fixed_version: v0.86.42`
