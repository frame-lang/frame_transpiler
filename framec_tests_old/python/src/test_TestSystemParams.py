...
class StartStateParameters:
    ...
    def __handle_s1_enter(self, __e, compartment):
    ...
    def __startstateparameters_state_S1(self, __e, compartment):
        if __e._message == "$>":
            return self.__handle_s1_enter(__e, compartment)
...
class StartStateEnterParameters:
    ...
    def __handle_s1_enter(self, __e, compartment):
        p1 = __e._parameters.get("p1") if __e._parameters else None
        print(p1)
        return
...
class AllParameterTypes:
    ...
    def __handle_s1_enter(self, __e, compartment):
        p2 = __e._parameters.get("p2") if __e._parameters else None
        print(((compartment.state_args["p1"] + p2) + self.a) + self.c)
        return
