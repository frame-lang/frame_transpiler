...
class SystemInitializationDemo:
    ...
    def __init__(self, E, F):
        ...
        self.__compartment = FrameCompartment('__systeminitializationdemo_state_Start', None, None, None, None, {}, {})
    ...
    def __handle_start_enter(self, __e, compartment):
        C = __e._parameters.get("C") if __e._parameters else None
        D = __e._parameters.get("D") if __e._parameters else None
        print(((((compartment.state_args["A"] + compartment.state_args["B"]) + C) + D) + self.E) + self.F)
        return
