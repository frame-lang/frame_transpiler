...
class TestService:
    ...
    def __init__(self):
        ...
        self.__compartment = FrameCompartment('__testservice_state_Ready', None, None, None, None, {}, {})
    ...
    def initialize(self,):
        ...
        __e = FrameEvent("initialize", None)
        self.__kernel(__e)
    ...
    def __handle_ready_initialize(self, __e, compartment):
    ...
    def __testservice_state_Ready(self, __e, compartment):
        if __e._message == "initialize":
            return self.__handle_ready_initialize(__e, compartment)
    ...
    def __router(self, __e, compartment=None):
        ...
        if target_compartment.state == '__testservice_state_Ready':
