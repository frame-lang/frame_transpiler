...
class HSM1:
    ...
    def __handle_s0_b(self, __e, compartment):
        next_compartment = FrameCompartment('__hsm1_state_S3', None, None, None, None, {}, {})
        self.__transition(next_compartment)
        return

    def __handle_s1_a(self, __e, compartment):
        parent_compartment = FrameCompartment('__hsm1_state_S0', None, None, None, None, {}, {})
        next_compartment = FrameCompartment('__hsm1_state_S2', None, None, None, parent_compartment, {}, {})
        self.__transition(next_compartment)
        return

    def __handle_s2_a(self, __e, compartment):
        parent_compartment = FrameCompartment('__hsm1_state_S0', None, None, None, None, {}, {})
        next_compartment = FrameCompartment('__hsm1_state_S1', None, None, None, parent_compartment, {}, {})
        self.__transition(next_compartment)
        return
    ...
    def __hsm1_state_S0(self, __e, compartment):
        if __e._message == "b":
            return self.__handle_s0_b(__e, compartment)
    ...
    def __hsm1_state_S1(self, __e, compartment):
        if __e._message == "a":
            return self.__handle_s1_a(__e, compartment)
    ...
    def __hsm1_state_S2(self, __e, compartment):
        if __e._message == "a":
            return self.__handle_s2_a(__e, compartment)
