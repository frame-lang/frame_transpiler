...
|-----------|-----------|---------|-------|
| test_controlled_hsm_loop.frm | ❌ | ❌ | DEBUG: Starting first pass - building symbol table
...
| test_functions_simple.frm | ✅ | ❌ | Traceback (most recent call last):
  File "/Users/marktruluck/projects/frame_transpiler/framec_tests/python/src/test_functions_simple.py", line 50, in <module>
    main()
    ~~~~^^
  File "/Users/mar |
| test_import_statements.frm | ✅ | ❌ |   File "/Users/marktruluck/projects/frame_transpiler/framec_tests/python/src/test_import_statements.py", line 34
    print("NumPy array: " + str( + arr + ))
                                         ^
 |
| test_legb_scope_resolution.frm | ✅ | ❌ | Traceback (most recent call last):
  File "/Users/marktruluck/projects/frame_transpiler/framec_tests/python/src/test_legb_scope_resolution.py", line 180, in <module>
    main()
    ~~~~^^
  File "/Use |
...
| test_system_isolation.frm | ✅ | ❌ | Traceback (most recent call last):
  File "/Users/marktruluck/projects/frame_transpiler/framec_tests/python/src/test_system_isolation.py", line 205, in <module>
    main()
    ~~~~^^
  File "/Users/ma |
...
| test_functions_simple.frm | ✅ | ❌ | ❌ FAIL |
